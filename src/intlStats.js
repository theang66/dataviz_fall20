...
// import countries from "./data/2019/countries.json";
...
// var zoomThings = d3.zoom().scaleExtent([1, 20]).on("zoom", zoomed);
...
// d3.json(countries, function (error, world) {
...
// import intlData from "./data/2019/intl_stats.json";
...
//   d3.queue().defer(d3.json, "explore-map/world-countries.json").await(ready);
...
//     d3.select("#panelInfo").html(
//       '<span id="countryTitle">' +
//         currYear +
//         " | " +
//         d.country_txt +
//         "</span>" +
...
//       .scaleExtent([1, 10])
//       .translateExtent([
//         [-dims.svg_dx, -dims.svg_dy],
//         [dims.width - dims.svg_dx * 2, dims.height - dims.svg_dy],
//       ])
//       .on("zoom", function () {
//         gMap.attr(
//           "transform",
...
//       .attr(
//         "transform",
//         "translate(" + margin.left + "," + sliderHeight / 2 + ")"
//       );
...
//             handleDrag(x.invert(d3.event.x));
//           })
//       );
...
//     var colorHistogram = d3
//       .scaleSqrt()
//       .domain([colorMin, colorMax])
//       .range([d3.rgb(colorRangeStart), d3.rgb(colorRangeEnd)]);

//     var svgHistogram = d3
//       .select("#slider-histogram")
//       .append("svg")
//       .attr("height", containerHeight)
//       .attr("width", containerWidth);
...
//     xHistogram.domain(
//       globalData.map(function (d) {
//         return d.iyear;
//       })
//     );
//     yHistogram.domain([
//       0,
//       d3.max(globalData, function (d) {
//         return d.num_killed;
//       }),
//     ]);
...
//       .attr("class", "bar")
//       .attr("x", function (d) {
//         return xHistogram(d.iyear);
//       })
//       .attr("y", function (d) {
//         return yHistogram(d.num_killed * 0.3);
//       })
//       .attr("width", xHistogram.bandwidth())
//       .attr("height", function (d) {
//         return containerHeight - yHistogram(d.num_killed * 0.3);
//       })
//       .style("fill", function (d) {
...
//     sizeSvg.select(".legendSize").call(legendSize);
